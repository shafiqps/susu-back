...
export class RedeemCreate1703438100134 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "rewards" ADD CONSTRAINT "PK_c6fb082a3114f35d0cc27c51a0" PRIMARY KEY ("id")`)
        ...
        await queryRunner.query(`ALTER TABLE "redeem" ADD CONSTRAINT "FK_c6fb082a3114f35g0cc27c518e0" FOREIGN KEY ("rewards_id") REFERENCES "customer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
